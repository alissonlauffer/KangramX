    ...
    public void processForwardFromMyName(MessageObject messageObject, long did) {
        ...
        if (messageObject.messageOwner.media != null && !(messageObject.messageOwner.media instanceof TLRPC.TL_messageMediaEmpty) && !(messageObject.messageOwner.media instanceof TLRPC.TL_messageMediaWebPage) && !(messageObject.messageOwner.media instanceof TLRPC.TL_messageMediaGame) && !(messageObject.messageOwner.media instanceof TLRPC.TL_messageMediaInvoice)) {
            ...
            if (messageObject.messageOwner.media.photo instanceof TLRPC.TL_photo) {
                sendMessage((TLRPC.TL_photo) messageObject.messageOwner.media.photo, null, did, emptyReplyMessageObject, messageOwnerMessage, messageObject.messageOwner.entities, null, params, true, 0, messageObject.messageOwner.media.ttl_seconds, messageObject);
            } else if (messageObject.messageOwner.media.document instanceof TLRPC.TL_document) {
                sendMessage((TLRPC.TL_document) messageObject.messageOwner.media.document, null, messageObject.messageOwner.attachPath, did, emptyReplyMessageObject, messageOwnerMessage, messageObject.messageOwner.entities, null, params, true, 0, messageObject.messageOwner.media.ttl_seconds, messageObject);
            } else if (messageObject.messageOwner.media instanceof TLRPC.TL_messageMediaVenue || messageObject.messageOwner.media instanceof TLRPC.TL_messageMediaGeo) {
                sendMessage(messageObject.messageOwner.media, did, emptyReplyMessageObject, null, null, true, 0);
                ...
                sendMessage(user, did, emptyReplyMessageObject, null, null, true, 0);
            } else if ((int) did != 0) {
                ArrayList<MessageObject> arrayList = new ArrayList<>();
            ...
            sendMessage(messageObject.messageOwner.message, did, emptyReplyMessageObject, webPage, true, entities, null, null, true, 0);
        } else if ((int) did != 0) {
            ArrayList<MessageObject> arrayList = new ArrayList<>();
            arrayList.add(messageObject);
            sendMessage(arrayList, did, true, 0);
        ...
        if (MessageObject.isGifDocument(document)) {
            mediaSendQueue.postRunnable(() -> {
                ...
                AndroidUtilities.runOnUIThread(() -> {
                    ...
                    sendMessage((TLRPC.TL_document) finalDocument, null, null, peer, replyingMessageObject, caption, null, null, null, notify, scheduleDate, 0, parentObject);
                });
            });
        } else {
